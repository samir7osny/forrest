...
def get_pattern(from_=0, to=10000):
    ...
    return {'t': t, 'pelvis_y_values': pelvis_y_values, 'foot_z_values': foot_z_values, 'left_foot_z_values': left_foot_z_values, 'right_foot_z_values': right_foot_z_values, 'left_foot_x_values': left_foot_x_values, 'right_foot_x_values': right_foot_x_values, 'pelvis_x_values': pelvis_x_values, 'from': from_, 'to': to, 'Hfoot': Hfoot, 'Fs': Fs, 'd': d}
